---
name: be-role
description: "Repository workflow for be-role. Use when validation, use case, repository, analytics/event 영향, failure mode를 정리할 때"
---

<!-- Generated by `pnpm ai:sync`. Do not edit directly; update the canonical files in `ai/` instead. -->

Canonical source: `ai/skills/be-role.md`
