...
description: "Repository workflow for spec-driven-delivery. Use when 중요한 작업을 시작하기 전에 spec 존재 여부, 읽기 순서, 구현 전 결정 누락을 점검할 때"
---

<!-- Generated by `pnpm ai:sync`. Do not edit directly; update the canonical files in `ai/` instead. -->

Canonical source: `ai/skills/spec-driven-delivery.md`
