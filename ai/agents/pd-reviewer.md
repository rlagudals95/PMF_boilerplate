...
2. Read `ai/skills/pd-role.md`.
3. Read the active work item's `brief.md`.
4. Read `ux-review.md` if it exists.
...
Always leave a short handoff packet for FE or the lead.
