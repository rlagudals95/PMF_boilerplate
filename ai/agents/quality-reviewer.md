...
1. Read `ai/skills/goal-driven-delivery.md`.
2. Read `docs/product-squad/goal-driven-delivery.md`.
3. Read the active work item's `quality-scorecard.md` and related role docs.
